...
public class Pessoas implements Serializable {
	...
	static public void lerArquivo() {
		...
		try {
			FileReader fr = new FileReader("Cobradores.json");
		...
		try {
			FileReader fr = new FileReader("Motoristas.json");
			BufferedReader br = new BufferedReader(fr);
		...
		try {
			FileReader fr = new FileReader("Passageiros.json");
			BufferedReader br = new BufferedReader(fr);
	...
	static public void salvarArquivo() {
		...
		try {
			FileWriter fw = new FileWriter("Motoristas.json");
		...
		try {
			FileWriter fw = new FileWriter("Cobradores.json");
			BufferedWriter bw = new BufferedWriter(fw);
		...
		try {
			FileWriter fw = new FileWriter("Passageiros.json");
			BufferedWriter bw = new BufferedWriter(fw);
